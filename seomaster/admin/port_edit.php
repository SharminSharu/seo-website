  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add new Portfolio</h5>
              </div>
              <div class="card-body">
              <form action="port_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                <div class="col-6">
        ...
        <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Portfolio List</h5>
              </div>
                <div class="card-body">
              <div class="container">
                <form action="port_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    <th>title_1</th>
                    <td><input type="text" name="title_1" 
                    value="<?php echo $data['title_1'] ?>" class="form-control"></td>
                </tr>
                <tr>
                    <th>title_2</th>
                    <td><input type="text" name="title_2" 
                    value="<?php echo $data['title_2'] ?>" class="form-control"></td>
                </tr>
