...
if(isset($_POST['name'])){
    ...
    $query="INSERT INTO `team` (`id`, `photo`, `name`,`designation` ) VALUES (NULL, '$file','$name', '$designation' )";
    $db->query($query);
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header bg-primary">
                ...
                <a href="team_list.php" class="btn btn-danger btn-xl" style="margin-left:89%"> Team_List</a>
                        ...
                        <tr>
                            ...
                            <td><img src="./dist/assets/<?php echo $data['photo'] ?>" width="100" height="80"/></td>
                               ...
                               <td>
                                ...
                                <a href="team_del.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
