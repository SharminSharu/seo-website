...
|
*/
$config['base_url'] = 'http://localhost/reactjs\seo_codigniter';
...
$config['key'] = "secret key"; // secret key
$config['iss'] = $config['base_url']; // domain name
$config['aud'] = $config['base_url']; // domain name
$config['iat'] = time(); // current time
$config['nbf'] = $config['iat'] + 5; // not using before 30 sec
$config['exp'] = $config['iat'] + 1*60;
